...
async function searchMeals() {
    ...
    try {
        ...
        resultHeading.textContent = `Search for "${searchTerm}"...`;
        ...
        if (data.meals === null) {
            ...
            mealsContainer.innerHTML = "";
            errorContainer.textContent = `No recipe found for "${searchTerm}".
...
async function handleMealClick(event) {
    ...
    try {
        ...
        errorContainer.textContent = `Could not load recipe details. Please try again later. ${error.message}`;
        errorContainer.classList.remove("hidden");
    }
}